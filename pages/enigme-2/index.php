...
<body>
	...
	<main>
		...
		<p>
			Au centre névralgique de la cité, <br />
			<br />
			Un bâtiment majestueux, vous allez trouver. <br />
			<br />
			Situé sur l'île de la Cité, je suis un témoin silencieux de l'histoire, <br />
			<br />
			Siège du gouvernement local, lieu de décisions,
		</p>

		<label for="rep-2">Qui suis-je?</label>
		<input id="rep-2" type="text" />
		<button class="btn_a" onclick="rep_2()">Envoyer</button>
	</main>
	<footer>
