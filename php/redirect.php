...
if (count($remainingDestinations) > 0) {
    ...
    setcookie('visited_pages', serialize($visitedPages), time() + 3600); // Cookie valide pendant 1 heure
    ...
    if ($lastVisitedPage === "../pages/enigme-6/") {
        // Redirection spécifique lorsque la dernière page visitée est "../pages/enigme-6/"
